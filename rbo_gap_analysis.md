...
OnSIR (`OnSIR.ttl`, 645 triples) declares **72** named `owl:Class` entities in the `https://w3id.org/onsir/` namespace, plus 23 object properties and 12 datatype properties. These 72 classes are the comparison set.

Two counting notes, so the figures can be reconciled with other descriptions of OnSIR. (i) The file contains 73 named `owl:Class` declarations in total; the extra one is `qudt:QuantityValue`, re-declared locally but not an OnSIR term. (ii) A count of `owl:Class`-typed nodes that does not filter blank nodes returns 80, because 7 anonymous class expressions (the intersections and restrictions used in the equivalence axioms) are also typed `owl:Class`; that 80 is a count of syntactic nodes, not of named terms. The defensible figure for OnSIR's own named classes is **72**.

1 further OnSIR IRI is used only in a class position (`rdfs:subClassOf` parent, `rdfs:domain`/`rdfs:range`, restriction filler) without an `owl:Class` declaration and is excluded: `onsir:QuantityValue`.

2 OnSIR classes carry no `rdfs:label` and were matched on their local name only: `onsir:MutagenicOutcome`, `onsir:StimulatoryOutcome`.

| # | OnSIR class | `rdfs:label` |
|---|---|---|
| 1 | `onsir:AbioticStressResistance` | Abiotic Stress Resistance |
| 2 | `onsir:Am241` | Am241 |
| 3 | `onsir:AntioxidantActivity` | AntioxidantActivity |
| 4 | `onsir:AntioxidantIncrease` | Antioxidant Increase |
| 5 | `onsir:BeneficialDoseRange` | Beneficial Dose Range |
| 6 | `onsir:BiochemicalChange` | Biochemical Change |
| 7 | `onsir:BioticStressResistance` | Biotic Stress Resistance |
| 8 | `onsir:BrainCousensModel` | Brain–Cousens Model |
| 9 | `onsir:ChlorophyllContent` | ChlorophyllContent |
| 10 | `onsir:Co60` | Co60 |
| 11 | `onsir:Context` | Context |
| 12 | `onsir:CotyledonFreeing` | CotyledonFreeing |
| 13 | `onsir:Cs137` | Cs137 |
| 14 | `onsir:DoseCategory` | Dose Category |
| 15 | `onsir:DoseRange` | Dose Range |
| 16 | `onsir:DoseRateCategory` | Dose-rate Category |
| 17 | `onsir:DoseResponseModel` | Dose–Response Model |
| 18 | `onsir:DryMass` | DryMass |
| 19 | `onsir:EarlySeedlingStage` | Early Seedling Stage |
| 20 | `onsir:ElectronBeam` | ElectronBeam |
| 21 | `onsir:Endpoint` | Endpoint |
| 22 | `onsir:EnzymeActivityChange` | Enzyme Activity Change |
| 23 | `onsir:FreshMass` | FreshMass |
| 24 | `onsir:Gamma` | Gamma |
| 25 | `onsir:GerminationRate` | GerminationRate |
| 26 | `onsir:GerminationStage` | Germination Stage |
| 27 | `onsir:HighDoseRate` | High Dose-rate |
| 28 | `onsir:HormeticDose` | Hormetic Dose |
| 29 | `onsir:HormeticResponse` | Hormetic Response |
| 30 | `onsir:Ir192` | Ir192 |
| 31 | `onsir:Isotope` | Radioisotope |
| 32 | `onsir:LifecycleStage` | Lifecycle Stage |
| 33 | `onsir:LightCondition` | Light Condition |
| 34 | `onsir:LipidPeroxidation` | LipidPeroxidation |
| 35 | `onsir:LowDoseRate` | Low Dose-rate |
| 36 | `onsir:MutagenicDose` | Mutagenic Dose |
| 37 | `onsir:MutagenicDoseRange` | Mutagenic Dose Range |
| 38 | `onsir:MutagenicOutcome` | _(none)_ |
| 39 | `onsir:MutagenicResponse` | Mutagenic Response |
| 40 | `onsir:MutationFrequency` | MutationFrequency |
| 41 | `onsir:Neutron` | Neutron |
| 42 | `onsir:Plant` | Plant |
| 43 | `onsir:PlantPart` | Plant Part |
| 44 | `onsir:PlantSeed` | Plant Seed |
| 45 | `onsir:PollenSterility` | PollenSterility |
| 46 | `onsir:Proton` | Proton |
| 47 | `onsir:ROSBalanceShift` | ROS Balance Shift |
| 48 | `onsir:RadiationType` | Radiation Type |
| 49 | `onsir:Response` | Response |
| 50 | `onsir:RootLength` | RootLength |
| 51 | `onsir:SeedIrradiationTreatment` | Seed Irradiation Treatment |
| 52 | `onsir:SeedStage` | Seed Stage |
| 53 | `onsir:SeedSterility` | SeedSterility |
| 54 | `onsir:SeedTreatment` | Seed Treatment |
| 55 | `onsir:Seedling` | Seedling |
| 56 | `onsir:SeedlingVigorIndex` | SeedlingVigorIndex |
| 57 | `onsir:ShootLength` | ShootLength |
| 58 | `onsir:SoilCondition` | Soil Condition |
| 59 | `onsir:SterilizationDose` | Sterilization Dose |
| 60 | `onsir:SterilizationDoseRange` | Sterilization Dose Range |
| 61 | `onsir:SterilizationResponse` | Sterilization Response |
| 62 | `onsir:StimulatoryOutcome` | _(none)_ |
| 63 | `onsir:StressResistance` | Stress Resistance |
| 64 | `onsir:Substrate` | Substrate |
| 65 | `onsir:TemperatureCondition` | Temperature Condition |
| 66 | `onsir:TreatmentOutcome` | Treatment Outcome |
| 67 | `onsir:UV_A` | UV_A |
| 68 | `onsir:UV_B` | UV_B |
| 69 | `onsir:UV_C` | UV_C |
| 70 | `onsir:WaterQuality` | Water Quality |
| 71 | `onsir:XRay` | XRay |
| 72 | `onsir:Xe133` | Xe133 |
...
**7 of 72 OnSIR classes (9.7%) have an exact match somewhere in the merged file.** Note that `onsir:Plant` matches ENVO's 'plant-associated environment' through a synonym rather than a plant class, and `onsir:Gamma` matches ChEBI's 'photon' through the synonym 'gamma'; neither is a usable alignment.
...
Against **RBO-native** classes, **69 of 72** OnSIR classes (95.8%) have neither an exact nor a near (>= 0.85) counterpart. Groups are the top-level class reached by following `rdfs:subClassOf` upwards inside the OnSIR namespace.
...
| OnSIR root class, no asserted superclass | 11 | `Context`, `DoseCategory`, `DoseRange`, `DoseRateCategory`, `DoseResponseModel`, `Isotope`, `LifecycleStage`, `MutagenicOutcome`, `RadiationType`, `StimulatoryOutcome`, `TreatmentOutcome` |
...
| DoseRange | 3 | `BeneficialDoseRange`, `MutagenicDoseRange`, `SterilizationDoseRange` |
...
| OnSIR root class, parent outside OnSIR: BFO_0000019 | 2 | `Endpoint`, `Response` |
| DoseResponseModel | 1 | `BrainCousensModel` |
| OnSIR root class, parent outside OnSIR: BFO_0000015 | 1 | `SeedTreatment` |
...
**OnSIR root class, no asserted superclass** (11)
...
- `onsir:MutagenicOutcome` -- MutagenicOutcome
- `onsir:RadiationType` -- Radiation Type
- `onsir:StimulatoryOutcome` -- StimulatoryOutcome
...
- `onsir:BeneficialDoseRange` -- Beneficial Dose Range
- `onsir:MutagenicDoseRange` -- Mutagenic Dose Range
- `onsir:SterilizationDoseRange` -- Sterilization Dose Range
...
**OnSIR root class, parent outside OnSIR: BFO_0000019** (2)
...
**OnSIR root class, parent outside OnSIR: BFO_0000015** (1)
...
Against **all** classes in the merged file, 62 of 72 OnSIR classes (86.1%) remain unmatched: `AbioticStressResistance`, `Am241`, `AntioxidantActivity`, `AntioxidantIncrease`, `BeneficialDoseRange`, `BiochemicalChange`, `BioticStressResistance`, `BrainCousensModel`, `ChlorophyllContent`, `CotyledonFreeing`, `DoseCategory`, `DoseRange`, `DoseRateCategory`, `DoseResponseModel`, `DryMass`, `EarlySeedlingStage`, `ElectronBeam`, `Endpoint`, `EnzymeActivityChange`, `FreshMass`, `GerminationRate`, `GerminationStage`, `HighDoseRate`, `HormeticDose`, `HormeticResponse`, `Ir192`, `Isotope`, `LightCondition`, `LipidPeroxidation`, `LowDoseRate`, `MutagenicDose`, `MutagenicDoseRange`, `MutagenicOutcome`, `MutagenicResponse`, `MutationFrequency`, `PlantPart`, `PlantSeed`, `PollenSterility`, `ROSBalanceShift`, `RadiationType`, `Response`, `RootLength`, `SeedIrradiationTreatment`, `SeedStage`, `SeedSterility`, `SeedTreatment`, `Seedling`, `SeedlingVigorIndex`, `ShootLength`, `SoilCondition`, `SterilizationDose`, `SterilizationDoseRange`, `SterilizationResponse`, `StimulatoryOutcome`, `StressResistance`, `Substrate`, `TemperatureCondition`, `TreatmentOutcome`, `UV_B`, `UV_C`, `WaterQuality`, `Xe133`.
...
OnSIR asserts `skos:closeMatch`, `skos:exactMatch`, `owl:equivalentClass` or `rdfs:subClassOf` links to 17 classes in the `obo:` namespace. Their presence in the merged rbo.owl file bounds how much of OnSIR could be re-expressed inside RBO's existing import surface.

| External class OnSIR aligns to | Label in rbo.owl | Present in rbo.owl? | Used by OnSIR class |
|---|---|---|---|
| `http://purl.obolibrary.org/obo/BFO_0000015` | process | yes | `SeedIrradiationTreatment`, `SeedTreatment` |
| `http://purl.obolibrary.org/obo/BFO_0000019` | quality | yes | `Endpoint`, `Response` |
...
| `http://purl.obolibrary.org/obo/CHEBI_749374` | _n/a_ | **no** | `Co60` |
